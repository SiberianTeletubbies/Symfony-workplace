 ...
 */
final class Version20181227141142 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE task (id SERIAL NOT NULL, user_id INT DEFAULT NULL, description VARCHAR(2500) NOT NULL, duration VARCHAR(255) NOT NULL, attachment VARCHAR(1000) DEFAULT NULL, attachment_file_name VARCHAR(1000) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE task ADD CONSTRAINT FK_527EDB25A76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
